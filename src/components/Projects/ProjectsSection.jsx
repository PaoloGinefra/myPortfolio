...
function ProjectSection({projects, tags, openModal, setProject}){
  ...
  function toggleSelectTool(id){
    ...
    if(Verbose)
      console.log('toolsHex=' + HexFromArray(newSlectedTools))
  ...
  return (
    <>
      <section className="text-white">
        ...
        <ToolsSection toggleSelectTool= {toggleSelectTool} SelectedTools={SelectedTools}/>

        <TagsSection tags = {tags} toggleSelectTag={toggleSelectTag} SelectedTags={SelectedTags}/>
